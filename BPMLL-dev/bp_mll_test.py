...
from evaluate_model import hamming_loss, find, findmax, sort, findIndex, avgprec, Coverage, OneError, rloss
...
#汉明损失
    print(dataset_name, 'hammingloss:', hamming_loss(y_test, ensemble_pred))
#1-错误率
